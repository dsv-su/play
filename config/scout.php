            ...
            App\Models\Video::class => [
                'collection-schema' => [
                    ...
                    'fields' => [
                        ...
                        ['name' => 'tag_names',             'type' => 'string[]', 'facet' => true],
                        ['name' => 'course_names',          'type' => 'string[]', 'facet' => true],
                        ['name' => 'course_designation',    'type' => 'string[]', 'facet' => true],
                        ['name' => 'presenter_names',       'type' => 'string[]', 'facet' => true],
                        ['name' => 'presenter_usernames',   'type' => 'string[]', 'facet' => true],
                        ['name' => 'tag_ids',               'type' => 'int64[]'],
                        ['name' => 'course_ids',            'type' => 'int64[]'],
                        ['name' => 'presenter_ids',         'type' => 'int64[]'],
                        ['name' => 'published_at_ts',       'type' => 'int64'],
                        ['name' => 'visibility',            'type' => 'int32',    'facet' => true ],
                        ['name' => 'unlisted',              'type' => 'int32',    'facet' => true ],
                    ],
