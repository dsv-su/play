...
{
    use HasFactory;
    protected $fillable = ['status', 'user','upload_dir', 'log', 'subtitles', 'title', 'title_en', 'creation', 'presenters', 'courses','daisy_courses', 'tags', 'thumb','permission', 'entitlement', 'sources', 'generate_subtitles', 'description'];
