...
class PlayController extends Controller
{
    ...
    public function index()
    {
        ...
        elseif (App::environment('production') and $courses = $daisy->getActiveEmployeeCourses(app()->make('play_username')) and (app()->make('play_role') == 'Uploader' or app()->make('play_role') == 'Staff')) {
            $data['permissions'] = VideoPermission::all();
            $data['my'] = Video::with('video_course.course')->whereHas('video_course.course', function ($query) use ($courses) {
