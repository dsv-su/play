...
class oldCourseIndividualTicket extends TicketPermissionHandler implements \App\Interfaces\TicketInterface
{
    ...
    public function cast()
    {
        foreach($this->courses as $this->course) {
            if($setting = $this->getCourseIndividuals($this->course->id)) {
                ...
                if($setting->username. '@su.se' == $_SERVER['REMOTE_USER'] && in_array($setting->permission, ['read', 'edit', 'delete'])) {
