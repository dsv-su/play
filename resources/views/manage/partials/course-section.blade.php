    ...
    <div class="p-4 sm:p-6">
        <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
            <div class="min-w-0 rounded-lg border border-slate-200 bg-slate-50 p-4 dark:border-neutral-700 dark:bg-neutral-950">
                ...
                <p class="mt-1 mb-3 text-sm text-slate-500 dark:text-neutral-400">{{__("Add or remove the course links used for search and course pages.")}}</p>
            ...
            <div class="min-w-0 rounded-lg border border-slate-200 bg-slate-50 p-4 dark:border-neutral-700 dark:bg-neutral-950">
                ...
                <p class="mt-1 mb-3 text-sm text-slate-500 dark:text-neutral-400">{{__("Review who is responsible for the selected course association.")}}</p>
