...
<div class="wrapper">
    ...
    <div class="head">
        ...
        <p class="dev">[Nu spelas: <span style="color: red;"> {{ $video->title }}</span>]</p>&nbsp;&nbsp;&nbsp;<p class="dev"> Player </p>&nbsp;&nbsp;&nbsp;<p class="dev">[width: <span id="width"></span></p>&nbsp;<p class="dev">height: <span id="height"></span>]</p>&nbsp;&nbsp; <p class="dev">[Streams: <span id="streams"></span>]</p>
        <!-- Toggle switch -->
