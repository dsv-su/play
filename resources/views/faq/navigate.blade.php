<h2 id="lang">{{__("Navigate and Play (All users)")}}</h2>
...
<article class="main-article webb2021-article main-column-left js-anchor-links-headers-container col-12 col-lg-8 main-column-padding-right">
    ...
    <ol class="lead-light txt-blok-3">
        <li>{{__("My courses, showing all viewable presentations for courses you are enrolled in (for students) or are involved in (for staff, uploaders and course administrators).")}}</li>
        <li>{{__("VT2022(Active courses), showing all viewable presentations for all currently ongoing courses during this semester at DSV.")}}</li>
    ...
    <p class="lead-light txt-blok-3">{{__("Click on the semester or course to see all connected presentations.")}}</p>
    <br>
