...
<article class="main-article webb2021-article main-column-left js-anchor-links-headers-container col-12 col-lg-8 main-column-padding-right">
    <p class="lead-light txt-blok-3">{{__("When you log in the DSVPLAY platform will know what your role is. There are four different roles for DSVPLAY users with varying permissions:")}}</p>
    <ul class="lead-light txt-blok-3">
