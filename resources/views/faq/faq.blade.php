...
<div id="wrapper">
    <nav class="navbar navbar-inverse fixed-top" id="sidebar-wrapper" >
        <ul class="nav sidebar-nav" id="myTab" role="tablist">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu animated fadeInLeft" role="menu">
                    <li><a href="#wiplay">What is DSVPlay</a></li>
                    <li><a href="#lang">Language</a></li>
                    <li><a href="#rap">Roles and permissions</a></li>
                    <li><a href="#courses">Else</a></li>
                </ul>
            </li>
