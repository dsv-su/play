    ...
    <div class="container px-1 py-1 mx-auto">
            ...
            <div class="col-sm-12">
                <div class="rounded border shadow p-3 my-2">
                    <div class="row justify-content-between text-left">
                        <div class="form-group col-md-6 col-lg-4 flex-column d-flex">
                            <img id="presentation" src="{{$thumb}}?{{ rand() }}" style="max-width: 300px;" class="mx-auto">
                            <div class="d-flex justify-content-center h-100"><div id="presentation_hidden" class="alert alert-warning m-auto" role="alert">{{ __("Presentation hidden") }}</div>
                            </div>
                        ...
                        <div class="form-group col-md-6 col-lg-8">
                            <div class="row">
                                <label class="col-4 mb-0">{{__("Title")}}</label>
                                <div class="col">{{$video->title}}</div>
                            </div>
                            <div class="row">
                                <label class="col-4 mb-0">{{ __("Origin") }}</label>
                            ...
                            <div class="row"><label class="col-4 mb-0">{{ __("Recording date") }}</label>
                                <div class="col">{{$date}}</div>
                            </div>
                            <div class="row"><label class="col-4 mb-0">{{ __("Duration") }}</label>
                                <div class="col">{{$duration}}</div>
                            </div>
                            <div class="row"><label class="col-4 mb-0">{{__('Course')}}
                                </label>
                                <div class="col">@if (empty($course)) {{ __("Not associated to a course") }} @else {{$course}} @endif</div>
                            </div>
                            <div class="row"><label for="visabilitySwitch" class="col-4 mb-0">{{__('Visibility')}}</label>
                            <div class="col">
                ...
                -->
                    ...
                    <div class="row justify-content-between text-left">
                        <div class="form-group col-sm-6 flex-column d-flex"><label
                                    class="form-control-label px-3">{{ __("Title") }}<span class="text-danger"> *</span></label>
                        ...
                        <!-- CreationDate -->
                        <div class="form-group col-sm-6 flex-column d-flex"><label
                                    class="form-control-label px-3">{{ __("Original Recording date") }}<span
                ...
                <!-- Add new Presenters -->
                    <div class="row justify-content-between text-left">
                        <div class="form-group col-sm-6 flex-column d-flex">
                            ...
                            <button type="button" wire:click.prevent="newpresenter({{$i}})"
                                    class="btn btn-outline-primary p-2 btn-sm">{{ __("Presenter") }} <i
                                        class="fas fa-user-plus"></i></button>
                        </div>

                        <!--
                        <div class="form-group col-sm-6 flex-column d-flex"><label
                                    class="form-control-label px-3">{{ __("Category") }}</label>
                    ...
                    <div class="row justify-content-between text-left">
                        ...
                        <div class="form-group col-sm-6 flex-column d-flex">
                            ...
                            <button type="button" wire:click.prevent="add_individual_perm"
                                    class="btn btn-outline-primary p-2 btn-sm">{{$ipermissions}} {{ __("Set") }} <i
                                        class="fas fa-user-plus"></i></button>
                        </div>
                    </div>
                                ...
                                <div class="d-inline">
                                    <div wire:ignore class="d-flex justify-content-between" id="perm-search">
                                        ...
                                        <input class="form-control mx-auto perm" id="perm-search-text-{{$key}}"
                                               ...
                                               aria-haspopup="true" autocomplete="off" aria-labelledby="perm-search">
                                ...
                                <div class="col mr-2">
                                    ...
                                    <small>
                                        <div class="custom-control custom-switch custom-switch-sm d-inline">
                                            <input type="checkbox" name="audio" id="audioSwitch{{$loop->index + 1}}"
        ...
        <div class="row justify-content-end">
            <div class="form-group col-sm-4">
                <button type="submit" class="btn-block btn btn-outline-primary">{{ __("Update") }}</button>
            </div>
        </div>
