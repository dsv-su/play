<div class="hs-tooltip block w-full min-w-0 sm:w-auto">
    ...
    <div class="relative mb-0 w-full sm:w-64 md:w-72 xl:w-80 max-w-full flex items-center border border-susecondary rounded-lg bg-white dark:bg-neutral-900 dark:border-neutral-700"
        ...
        <select id="courses-select"
                ...
                multiple
                aria-label="{{ __('Filter by Courses') }}"
                class="hidden"
                data-hs-select='{
                                "hasSearch": true,
                                ...
                                "toggleTag": "<button type=\"button\" aria-expanded=\"false\" aria-label=\"{{__('Filter by Courses')}}\"></button>",
    ...
    <div class="mt-1 flex flex-wrap gap-2">
        <button type="button"
                ...
                aria-label="{{ __('Clear course filter') }}"
