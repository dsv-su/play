    ...
    <div class="flex min-h-[3rem] items-center gap-x-3 rounded-lg border border-slate-200 bg-slate-50 px-3 dark:border-neutral-700 dark:bg-neutral-950">
        <label for="hs-xs-switch-download"
            ...
            <span class="absolute inset-0 rounded-full bg-slate-200 transition-colors
                         peer-checked:bg-blue-600 peer-focus-visible:ring-2 peer-focus-visible:ring-blue-500 peer-focus-visible:ring-offset-2 peer-focus-visible:ring-offset-white dark:bg-neutral-700 dark:peer-checked:bg-blue-500 dark:peer-focus-visible:ring-offset-neutral-950"></span>
        ...
        @if($download)
            <span id="download-status" class="inline-flex items-center rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-xs font-semibold text-blue-700 dark:border-blue-900/70 dark:bg-blue-950 dark:text-blue-300" role="status" aria-live="polite">
            {{__("Downloadable")}}
        </span>
        @else
            <span id="download-status" class="inline-flex items-center rounded-full border border-red-200 bg-red-50 px-3 py-1 text-xs font-semibold text-red-700 dark:border-red-900/70 dark:bg-red-950 dark:text-red-300" role="status" aria-live="polite">
            {{__("Not Downloadable")}}
        </span>
        @endif
    </div>
