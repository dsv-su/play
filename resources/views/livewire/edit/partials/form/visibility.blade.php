<div class="min-w-0 rounded-lg border border-slate-200 bg-slate-50 p-4 dark:border-neutral-700 dark:bg-neutral-950">
    ...
    <p id="visibility-description" class="mt-1 mb-3 text-sm text-slate-500 dark:text-neutral-400">{{__("This controls whether users can search for and play the presentation.")}}</p>
