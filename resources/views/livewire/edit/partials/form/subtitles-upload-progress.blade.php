...
@if(count($files ?? []))
    <div class="mb-4 flex flex-col rounded-lg border border-susecondary bg-white shadow-sm dark:border-susecondary dark:bg-neutral-900" role="status" aria-live="polite">
        <div class="space-y-4 p-4">
            ...
            @foreach($files as $file)
                <div>
                    <div class="mb-3 flex items-center justify-between gap-3">
                        <div class="flex items-center gap-x-3">
                          <span class="flex size-9 items-center justify-center rounded-lg border border-blue-200 bg-blue-50 text-blue-700 dark:border-blue-900/70 dark:bg-blue-950 dark:text-blue-300">
                            <svg class="size-5 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div class="inline-flex items-center gap-x-2">
                            @if($stored)
                                <span class="relative">
                                    <svg class="shrink-0 size-4 text-teal-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                            ...
                            @else
                                <button @click="removeUpload('{{$file->getFilename()}}')"
                                        ...
                                        aria-label="{{ __('Delete subtitle upload') }} {{$file->getClientOriginalName()}}">
                                    <svg class="size-4 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <path d="M3 6h18"></path>
                    ...
                    <div class="flex h-2 w-full overflow-hidden rounded-full bg-slate-200 dark:bg-neutral-700" role="progressbar" aria-label="{{ __('Subtitle upload progress') }}" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">
