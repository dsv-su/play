<div class="relative w-1/2 ml-auto">
    ...
    <!-- Switch (now second, on the right) -->
        <label for="hs-xs-switch-bulkpresenter"
               class="relative inline-flex items-center cursor-pointer">
            <input
                type="checkbox"
                id="hs-xs-switch-bulkpresenter"
                class="peer sr-only"
                name="bulkpresenter"
                wire:model.live="bulkpresenter"
            >
    ...
    <input type="hidden" name="bulkpresenter" value="{{ $bulkpresenter }}">
</div>
