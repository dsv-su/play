<div class="max-w-screen-xl mx-auto px-4 py-6 sm:px-6 lg:px-6 md:pt-8 md:pb-8 space-y-8">
    ...
    <div class="flex flex-col bg-white border border-gray-200 shadow-2xs rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70">
        ...
        <div class="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between border-b border-gray-200 rounded-t-xl py-3 px-4 md:px-5 dark:border-neutral-700">
            <!-- Filters -->
        ...
        <div class="p-2 md:p-3">
            ...
            <div
                ...
                x-init="init()"
                class="mt-4 relative w-full mx-auto {{--}}overflow-hidden{{--}}overflow-visible
