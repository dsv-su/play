    ...
    <div class="inline-flex rounded-md shadow-sm space-x-0.5" role="group">
        ...
        @if ($video->edit && $video->state)
            <a
                ...
                class="inline-flex min-h-6 min-w-6 items-center justify-center gap-1 px-1 py-1 text-xs font-medium text-gray-900 bg-transparent rounded-md hover:bg-gray-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2 dark:text-white dark:hover:bg-gray-700 dark:focus-visible:ring-offset-neutral-950"
                title="{{ __('Edit presentation') }}"
                aria-label="{{ __('Edit :title', ['title' => $video->LangTitle]) }}">
        ...
        @if ($video->delete && $video->state)
            <form
                ...
                <button
                    ...
                    data-tooltip-placement="top"
                    class="inline-flex min-h-6 min-w-6 items-center justify-center gap-1 px-1 py-1 text-xs font-medium bg-transparent rounded-md text-red-700 hover:bg-red-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-600 focus-visible:ring-offset-2 dark:text-red-400 dark:hover:bg-red-600 dark:focus-visible:ring-offset-neutral-950"
                    title="{{ __('Delete presentation') }}"
                    aria-label="{{ __('Delete :title', ['title' => $video->LangTitle]) }}">
                    <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
