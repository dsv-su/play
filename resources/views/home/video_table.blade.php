...
<div class="videotable p-0 mb-0 bg-white overflow-hidden row mx-1 w-100 border-bottom-grey d-flex align-content-center @if($video->hidden) faded @endif"
     id="{{$video->id}}">
    <div class="col-12 col-sm info p-2">
        ...
        <h4 class="card-text font-1rem font-weight-bold py-1 d-inline-block my-auto">
    ...
    <div class="col-12 col-sm-auto p-1 my-auto">
        <span class="card-text text-font-size-80 font-weight-normal py-2">{{$video->getCreationDate()}}</span>
    </div>


    <div class="col-auto action p-2 d-flex justify-content-center">
        <div id="action-icons" class="d-flex flex-row my-auto">
            <div class="mr-1"><span data-placement="left" data-toggle="tooltip" title="{{__("Share presentation")}}">
